...
function Card({card, onCardClick, onDeleteConfirmPopup, isDeleteConfirmPopupOpen}) {
    function handleClick() {
        onCardClick(card);
      }  
    return (
        <div className="element" key={card._id}>
        <button class="element__trash" type="button" onClick={onDeleteConfirmPopup}>
          <img
        ...
        <img alt={card.name} class="element__image" src={card.link} onClick={handleClick}/>
